...
public class CustomItems implements CommandExecutor {
    ...
    public CustomItems(Kingdoms plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if (!(sender instanceof Player player)) {
            ...
            if (args.length == 0) {
                ...
                /*
                    {Black} Warzone Coal -> Value: 3 coins                       Slot: 28
                    {Aqua} Warzone Gold -> Value: 5 coins                       Slot: 29
                    {Gray} Warzone Iron -> Value: 7 coins                       Slot: 30
                    {Aqua} Warzone Diamond -> Value: 10 coins                   Slot: 31
                    {Green} Warzone Emerald -> Value: 25 coins                  Slot: 32
                    Goblin Skin -> Value: 2500 coins                            Slot: 14
                */
