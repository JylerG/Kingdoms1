                ...
                if (args.length == 1) {
                    ...
                    if (target != null) {
                        if (!target.getGameMode().equals(GameMode.CREATIVE)) {
                            ...
                            player.sendMessage(ChatColor.GRAY + "You set " + ChatColor.WHITE + target.getName() + ChatColor.GRAY + "'s gamemode to " + ChatColor.LIGHT_PURPLE + "Creative");
                            target.sendMessage(ChatColor.GRAY + "Your gamemode was set to " + ChatColor.LIGHT_PURPLE + "Creative ");
                        } else {
                            player.sendMessage(target.getName() + ChatColor.RED + " is already in gamemode " + ChatColor.LIGHT_PURPLE + "Creative");
                        }
                    } else {
